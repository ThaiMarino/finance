...
def add_cash():
    ...
    if request.method == "GET":
        ...
        if not new_cash:
            return apology("Must give valid value.")
...
def register():
    ...
    if request.method == "GET":
        ...
        try:
            # INSERT INTO table_name (column 1, column 2, columnn 3, ...) VALUES (value1, value2, value3 ...)
...
def sell():
    ...
    if request.method == "GET":
        ...
        if shares > user_shares_real:
            return apology("Amount of shares invalid. Confirm if you have this amount.")
